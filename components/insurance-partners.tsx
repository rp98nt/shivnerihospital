...
function InsurancePartnerCard({ partner }: { partner: InsurancePartner }) {
  return (
    <article className="insurance-partner-card group flex shrink-0 items-center justify-center rounded-xl border border-slate-100 bg-white px-5 py-3 sm:px-6 sm:py-3.5">
      <Image
        src={partner.logo}
        alt={partner.name}
        width={208}
