...
function TopBarDirectionsContact({ compact = false }: { compact?: boolean }) {
  if (compact) {
    return (
      ...
      >
        <span className="flex h-7 w-7 items-center justify-center overflow-visible [&_.directions-marker-icon-shell]:!m-0 [&_.directions-marker-icon-shell]:!h-7 [&_.directions-marker-icon-shell]:!w-7 [&_.directions-marker-icon-shell]:!-translate-y-2">
  ...
  return (
    ...
    >
      <span
        className={`${TOP_BAR_ICON_SLOT_CLASS} overflow-visible [&_.directions-marker-icon-shell]:!m-0 [&_.directions-marker-icon-shell]:!h-7 [&_.directions-marker-icon-shell]:!w-7 lg:[&_.directions-marker-icon-shell]:!-translate-y-1`}
      >
        <DirectionsMarkerIcon />
      </span>
